	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-8">
		...
		>
			...
			<div class="border-b px-5 py-3">
				<h2 class="text-2xl font-bold text-blue-900">Equipment Return Confirmation</h2>
			</div>
			...
			<div class="space-y-3 px-5 py-4">
				<div class="grid gap-3 md:grid-cols-2">
					...
					<div>
						<p class="text-sm text-slate-500">Equipment</p>
					...
					<div>
						<p class="text-sm text-slate-500">Student Department</p>
					...
					<div>
						<p class="text-sm text-slate-500">Equipment Department</p>
					...
					<div>
						<p class="text-sm text-slate-500">Issued Date</p>
				...
				<div class="grid gap-3 md:grid-cols-2">
					<div>
						<label class="font-semibold"> Late Days </label>
					...
					<div>
						<label class="font-semibold"> Late Fine </label>
				...
				<div>
					<label class="font-semibold"> Damage Status </label>

					<select bind:value={damageType} class="mt-2 w-full rounded-xl border p-3">
						<option>None</option>
						<option>Minor</option>
						<option>Major</option>
						<option>Lost</option>
				...
				<div class="grid gap-3 md:grid-cols-2">
					<div>
						<label class="font-semibold"> Damage Fine </label>
					...
					<div>
						<label class="font-semibold text-red-600"> Total Fine </label>
				...
				<label class="flex items-center gap-3">
					...
					<span class="font-medium"> I confirm that the equipment has been received. </span>
				</label>
			</div>
