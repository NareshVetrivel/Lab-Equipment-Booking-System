...
>
	...
	<div class="space-y-4 p-6">
		...
		<div>
			<p class="text-sm font-semibold text-slate-500">Available Quantity</p>
		...
		<button
			type="button"
			class="mt-4 w-full rounded-xl bg-blue-700 px-5 py-3 font-semibold text-white transition hover:bg-blue-800"
