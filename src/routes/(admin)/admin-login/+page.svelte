...
<div class="flex min-h-screen flex-col bg-gradient-to-br from-slate-100 via-white to-blue-100">
	...
	<main class="relative flex flex-1 items-center justify-center px-4 py-10">
		...
		<div class="pointer-events-none absolute inset-0 overflow-hidden">
			<div class="absolute left-0 top-10 h-72 w-72 rounded-full bg-blue-500/20 blur-3xl"></div>

			<div class="absolute bottom-10 right-0 h-96 w-96 rounded-full bg-slate-500/20 blur-3xl"></div>
		</div>
		...
		>
			...
			<div class="mb-8 text-center">
				...
				<h1 class="text-4xl font-bold text-blue-950">Admin Login</h1>

				<p class="mt-3 text-slate-600">Laboratory Equipment Booking System</p>
			</div>
			...
			>
				...
				<div class="flex flex-col gap-2">
					<label for="adminId" class="text-sm font-semibold text-slate-700"> Admin Email </label>
